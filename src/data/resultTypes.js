export const resultTypes = {
  action: {
    ...
    mission: "迷っていたことを、今日5分だけ始めてみましょう。"
  },
  creator: {
    title: "創造力タイプ",
    en: "Creator",
    icon: "🎨",
    essence: "あなたは新しい発想を生み出し、まだ形のないものに命を吹き込める人です。",
    strength: "人と違う視点を持ち、アイデアで周りに刺激を与えられます。",
    mission: "思いついたアイデアを1つ、メモに残しましょう。"
  },
  intuition: {
    title: "直感力タイプ",
    en: "Intuitive",
  ...
  expression: {
    ...
    mission: "今の気持ちを短い言葉で表してみましょう。"
  },
  explorer: {
    title: "探究力タイプ",
    en: "Explorer",
    icon: "🔎",
    essence: "あなたは知りたい、深めたいという気持ちを大切にする人です。",
    strength: "学び続けることで、他の人には見えない答えを見つけられます。",
    mission: "気になることを1つ調べ、誰かに説明できる形にしましょう。"
  },
  challenger: {
    title: "挑戦力タイプ",
    en: "Challenge",
