...
| Luminary | `luminary` | `n11-luminary-` |
...
Luminary Current Official uses `n11-luminary-01`–`n11-luminary-20`. The former management definition `n11-light-bringer-*` is superseded and is not a valid Version 3.5 Official Question ID. Its historical use is preserved in the Revision 3 archive and Revision History.
